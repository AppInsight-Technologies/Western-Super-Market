...
class _HomeScreenState extends State<HomeScreen> with Navigations{
  ...
  void initState() {
    ...
    subscriptionApibox.getSubsctiptionBox(ParamBodyDatabox(type: "all", branch: PrefUtils.prefs!.getString("branch"), languageid: IConstants.languageId, user: !(PrefUtils.prefs!.containsKey("apikey")) ? PrefUtils.prefs!.getString("tokenid") !: PrefUtils.prefs!.getString('apikey')!,subscription_type: "Flexible")).then((value){
      setState(() {
