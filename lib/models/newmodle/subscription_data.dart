...
final subscriptionApibox = SubscriptionApi();
class ParamBodyDatabox {
  ...
  ParamBodyDatabox({this.type, this.branch, this.languageid, this.user ,this.subscription_type});
...
class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    itemFeaturedImage = json['item_featured_image'];
